		...
		return (
			...
			(function t(i, r) {
				...
				if (
					...
					i.keywords &&
						(i.keywords = j(i.keywords, e.case_insensitive)),
					i.lexemes && o)
				)
					throw Error(
		...
		function f(e, t, s, l) {
			...
			function h(e) {
				return (
					e.className &&
						k.openNode(
							v.classNameAliases[e.className] || e.className
						),
		...
		return (n) => {
			const r = n.COMMENT("//", "$", { contains: [{ begin: /\\\n/ }] }),
				...
				l = {
					...
					contains: [
						{ begin: /\\\n/, relevance: 0 },
						n.inherit(c, { className: "meta-string" }),
						{
							className: "meta-string",
							begin: /<.*?>/,
						},
...
hljs.highlightLines = function (code, area) {
